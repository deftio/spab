...
- [`docs/encoding-walkthrough.md`](docs/encoding-walkthrough.md) — **a worked example,
  end to end**: a 27-byte secret traced from bytes to wire packet to ECC stream to
  symbol blocks to glyphs, and back. Every number is regenerated by
